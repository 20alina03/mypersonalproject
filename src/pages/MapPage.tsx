        ...
        <Tabs defaultValue="my-map" className="w-full">
          ...
          <TabsContent value="community">
            <div className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-4">This feature will show locations popular among other Atlas users.</p>
          ...
          <TabsContent value="wishlist">
            <div className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-4">Mark places you want to visit in the future.</p>
